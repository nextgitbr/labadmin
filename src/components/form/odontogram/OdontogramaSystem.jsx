  ...
  return (
    <div className="odontograma-system">
      ...
      {showInstructions && (
        <div className="instructions-modal">
          <div className="instructions-content">
            ...
            <h3>📋 Instruções do Sistema de Odontograma</h3>
            ...
            <div className="grid grid-cols-8 gap-2 mb-3">
              <div>
                ...
                <ul>
                  ...
                  <li>Dentes selecionados ficam destacados</li>
                  <li>Múltiplos dentes podem ser selecionados</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul>
                  <li>Escolha o tipo de construção desejado</li>
                  <li>Aplique aos dentes selecionados</li>
                  <li>Cores diferentes para cada tipo</li>
                </ul>
              </div>
      ...
      <div className="main-grid">
        ...
        {/* Coluna 2: Tipos de Construção e Vita */}
        ...
        {/* Coluna 3: Lista de Dentes e Arquivos */}
        <div className="teeth-and-files-section">
          ...
          <div className="constructions-list">
            ...
            <div className="work-type-section">
              ...
              <button
                ...
                className={`work-type-btn ${workType === 'acrilico' ? 'selected' : ''}`}
                style={{
              ...
              <button
                ...
                className={`work-type-btn ${workType === 'cadcam' ? 'selected' : ''}`}
                style={{
                  ...
                  <div className="material-buttons">
                    {[
                      ...
                      <button
                        ...
                        className={`material-btn ${selectedMaterial === material.name ? 'selected' : ''}`}
                        style={{
              ...
              {Object.entries(toothConstructions).length === 0 ? (
                ...
                (() => {
                  ...
                  return Object.entries(groupedConstructions).map(([type, teeth]) => (
                    <div key={type} className="construction-item" style={{backgroundColor: CONSTRUCTION_TYPES[type]}}>
                      <span>Dentes {teeth.sort((a, b) => parseInt(a) - parseInt(b)).join(', ')}: {type}</span>
                      <div className="flex gap-1">
                        {teeth.map(tooth => (
                          <button 
                            key={tooth}
                            onClick={() => removeConstructionType(tooth)}
                            className="bg-red-500 hover:bg-red-600 text-white px-1 py-0 rounded text-xs"
