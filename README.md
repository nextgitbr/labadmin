# Lab Admin Next.js - Free Next.js Tailwind Admin Dashboard Template
...
Lab Admin is a pre-designed starting point for building a web-based dashboard using Next.js and Tailwind CSS. The template includes:
